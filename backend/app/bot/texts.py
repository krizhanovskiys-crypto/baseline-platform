...
_TEXTS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "choose_courts": "🏟 Choose your courts in {zone} (tap to toggle, then tap ✅ Done):",
        "custom_courts_divider": "── Custom Courts ──",
        "btn_add_own_court": "➕ Add my own court",
        "custom_court_prompt": "Enter the court name:\n\n_Example: High Park Bubble_",
        "custom_court_empty_error": "⚠️ Please enter a court name.",
        "custom_court_added": "✅ Court added successfully.\n\nIt will be used when searching for partners.",
        ...
        "announcement_header": "🚀 *Baseline updated!*\n\nVersion {version}",
        "announcement_btn_continue": "▶️ Continue",
        "announcement_btn_whats_new": "✨ What's New",
        "whats_new_header": "✨ *What's New*\n\nVersion {version}",
        "whats_new_btn_continue": "▶️ Continue",
        # Find partner
        ...
        "tournament_match_wrong_status": "❌ This match has already been completed.",
        "tournament_match_winner_not_participant": "❌ That player isn't part of this match.",
        # Enter Result — Who Won? prompt (Sprint 16, Step 3)
        "tournament_dashboard_who_won": "🏆 *Who won?*",
        "tournament_dashboard_winner_option": "🥇 {name}",
        "tournament_dashboard_winner_confirmed": "✅ Winner: {name}",
    ...
    "uk": {
        ...
        "choose_area": "📍 Оберіть свій район:",
        "choose_courts": "🏟 Оберіть корти в районі {zone} (натисніть для вибору, потім ✅ Готово):",
        "custom_courts_divider": "── Власні корти ──",
        "btn_add_own_court": "➕ Додати свій корт",
        "custom_court_prompt": "Введіть назву корту:\n\n_Наприклад: High Park Bubble_",
        "custom_court_empty_error": "⚠️ Будь ласка, введіть назву корту.",
        "custom_court_added": "✅ Корт успішно додано.\n\nВін буде використовуватись під час пошуку партнерів.",
        ...
        "announcement_header": "🚀 *Baseline оновлено!*\n\nВерсія {version}",
        "announcement_btn_continue": "▶️ Продовжити",
        "announcement_btn_whats_new": "✨ Що нового",
        "whats_new_header": "✨ *Що нового*\n\nВерсія {version}",
        "whats_new_btn_continue": "▶️ Продовжити",
        ...
        "tournament_match_wrong_status": "❌ Цей матч вже завершено.",
        "tournament_match_winner_not_participant": "❌ Цей гравець не бере участі в цьому матчі.",
        "tournament_dashboard_who_won": "🏆 *Хто переміг?*",
        "tournament_dashboard_winner_option": "🥇 {name}",
        "tournament_dashboard_winner_confirmed": "✅ Переможець: {name}",
    ...
    "ru": {
        ...
        "choose_area": "📍 Выберите свой район:",
        "choose_courts": "🏟 Выберите корты в районе {zone} (нажмите для выбора, затем ✅ Готово):",
        "custom_courts_divider": "── Собственные корты ──",
        "btn_add_own_court": "➕ Добавить свой корт",
        "custom_court_prompt": "Введите название корта:\n\n_Например: High Park Bubble_",
        "custom_court_empty_error": "⚠️ Пожалуйста, введите название корта.",
        "custom_court_added": "✅ Корт успешно добавлен.\n\nОн будет использоваться при поиске партнёров.",
        ...
        "player_card_area_suffix": "📍 Район: {area}",
        "announcement_header": "🚀 *Baseline обновлён!*\n\nВерсия {version}",
        "announcement_btn_continue": "▶️ Продолжить",
        "announcement_btn_whats_new": "✨ Что нового",
        "whats_new_header": "✨ *Что нового*\n\nВерсия {version}",
        "whats_new_btn_continue": "▶️ Продолжить",
        ...
        "tournament_match_wrong_status": "❌ Этот матч уже завершён.",
        "tournament_match_winner_not_participant": "❌ Этот игрок не участвует в этом матче.",
        "tournament_dashboard_who_won": "🏆 *Кто победил?*",
        "tournament_dashboard_winner_option": "🥇 {name}",
        "tournament_dashboard_winner_confirmed": "✅ Победитель: {name}",
...
# Tennis Zones and the Court Registry (COURTS_BY_ZONE, TENNIS_ZONES) live in
# backend/app/data/courts.py — the single source of truth for zones/courts.
