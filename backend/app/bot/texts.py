...
_TEXTS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "choose_area": "📍 Choose your Tennis Zone:",
        "choose_courts": "🏟 Select your courts in {zone} (tap to toggle, then tap ✅ Done):",
        ...
        "available_matches_filter_area": "📍 Zone",
        ...
        "available_matches_choose_area": "Choose Zone",
        ...
        "edit_profile_field_area": "📍 Tennis Zone",
    ...
    "uk": {
        ...
        "choose_area": "📍 Оберіть свою тенісну зону:",
        "choose_courts": "🏟 Оберіть корти у зоні {zone} (натисніть для вибору, потім ✅ Готово):",
        ...
        "available_matches_filter_area": "📍 Зона",
        ...
        "available_matches_choose_area": "Оберіть зону",
        ...
        "edit_profile_field_area": "📍 Тенісна зона",
    ...
    "ru": {
        ...
        "choose_area": "📍 Выберите свою теннисную зону:",
        "choose_courts": "🏟 Выберите корты в зоне {zone} (нажмите для выбора, затем ✅ Готово):",
        ...
        "available_matches_choose_area": "Выберите зону",
        ...
        "edit_profile_field_area": "📍 Теннисная зона",
